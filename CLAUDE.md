...
Réglages de jeu : `settings.json` (son : musique d'ambiance, coupée par défaut ; rencontres, nuit, bloom, naufrage, tempête : foudre et kraken, baleine et estime (Godot), fantômes, calendrier, climat, dauphins, rechargement des pièces, hommes sur le pont).
