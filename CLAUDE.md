...
Réglages de jeu : `settings.json` (son : musique d'ambiance, coupée par défaut ; rencontres, nuit, bloom, naufrage, tempête : foudre et kraken, baleine, serpent de mer, brume de surface et estime (Godot), fantômes, calendrier, climat, dauphins, rechargement des pièces, hommes sur le pont).
